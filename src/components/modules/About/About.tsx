        ...
        <div className="w-full lg:w-1/2 space-y-4">
          ...
          >
            ...
            <p className="text-gray-200 font-[Georgia] leading-relaxed">
              {open ? (
                <>
                  I am a Web, Frontend or React.js developer and I have skills in
                  React/Next.js, Tailwind CSS, JavaScript, Node.js, Express.js,
                ...
                <>
                  ...
                  crafting intuitive digital solutions. I specialize in React,
